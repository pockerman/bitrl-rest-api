...
tensorboard_api_router = APIRouter(prefix="/tensorboard-api", tags=["tensorboard-api"])
...
@tensorboard_api_router.post("/init")
...
@tensorboard_api_router.post("/close")
...
@tensorboard_api_router.post("/add-scalar")
...
@tensorboard_api_router.post("/add-scalars")
...
@tensorboard_api_router.post("/add-text")
